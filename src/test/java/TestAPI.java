...
public class TestAPI {
    ...
    public void sessionCreation(){
        ...
        token = response1.path("session.token").toString();
        //return token;
    }
    ...
    public void userSignIn(){
        ...
        post.put("token", token/*"7f30592aa0875260fcb0997ef96167f6a901292d"*/);
    ...
    public void sessionInfo(){
        Map<String,String> post = new HashMap<>();
        post.put("token", token/*"b41ce6f1187b0953b45c28464e6ce6504001292d"*/);
